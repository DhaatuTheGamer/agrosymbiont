                        ...
                        {markers.map((marker, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <circle r={8} fill="#2a52be" opacity={0.3} className="animate-ping" />
                                    <MapPin className="text-white w-4 h-4 -translate-x-2 -translate-y-2 pointer-events-none" strokeWidth={2.5}/>
                                </motion.g>
                            </Marker>
                        ))}
                    </ComposableMap>
